...
.Valid Usage
****
  * [[VUID-vkCmdClearAttachments-pAttachments-07270]]
    For each element of pname:pAttachments, the corresponding attachment in
    the current render pass instance must: either not be backed by an image
    view, or contain each of the aspects specified in pname:aspectMask
