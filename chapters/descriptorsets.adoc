...
ifdef::VK_EXT_mutable_descriptor_type,VK_VALVE_mutable_descriptor_type[]
  ...
  * [[VUID-VkDescriptorSetLayoutCreateInfo-flags-03000]]
    if (is_version(1, 2) or is_ext_enabled(VK_EXT_descriptor_indexing) and
        has_pnext(VkDescriptorSetLayoutBindingFlagsCreateInfo)):
...
ifdef::VK_EXT_mutable_descriptor_type,VK_VALVE_mutable_descriptor_type[]
  ...
  * [[VUID-VkDescriptorSetLayoutCreateInfo-pBindings-07303]]
    if (is_ext_enabled(VK_EXT_mutable_descriptor_type) or is_ext_enabled(VK_VALVE_mutable_descriptor_type)):
      for binding in pBindings:
